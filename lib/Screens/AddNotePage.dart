...
import 'package:keluhkesalku/Helpers/modalSelectCategory.dart';
import 'package:keluhkesalku/Widgets/SelectedColor.dart';
import 'package:keluhkesalku/Widgets/TextFieldBody.dart';
import 'package:keluhkesalku/Widgets/TextFieldTitle.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: TextFrave(text: '', fontWeight: FontWeight.w500, fontSize: 21),
        centerTitle: true,
        leading: InkWell(
